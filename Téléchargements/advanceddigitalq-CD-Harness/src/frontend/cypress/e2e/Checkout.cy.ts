...
describe('Checkout Flow', () => {
  ...
  beforeEach(() => {
    ...
    // Calculate and log the execution time for visiting the page
    const visitTime = new Date().getTime() - startTime;
    cy.log(`Visiting the page took ${visitTime} milliseconds`);
  });
